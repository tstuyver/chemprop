...
class MinMaxScaler:
    #Work in progress; you need to include atom_scale etc.
    """A :class:`MinMaxScaler` scales the features of a dataset.

    When it is fit on a dataset, the :class:`MinMaxScaler` learns the min and max across the 0th axis.
    When transforming a dataset, the :class:`StandardScaler` subtracts the min and divides by the (max - min).
    """
